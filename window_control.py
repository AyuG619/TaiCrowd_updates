...
class MyMainWindow(QMainWindow,Ui_MainWindow):
    ...
    def read_ini_file(self, file_name):
        ...
        # print(f"=== CONFIG DEBUG AFTER READING INI ===")
        # print(f"self.config.scene = {getattr(self.config, 'scene', 'NOT SET')}")
        # print(f"self.config.use_gender = {getattr(self.config, 'use_gender', 'NOT SET')}")
        # print(f"len(self.config.gender) = {len(getattr(self.config, 'gender', []))}")
